...
@HostPlugin(revision = "$Revision: 19277 $", interfaceVersion = 2, names = { "freakshare.net", "freakshare.com" }, urls = { "REGEXNOTUSED_BLAHASDAHAHDAHAHSDHAHDASDHAHD1223", "http://(www\\.)?freakshare\\.(net|com)/files?/[\\w]+/.+(\\.html)?" }, flags = { 0, 2 })
public class Freaksharenet extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, InterruptedException, PluginException {
        ...
        if (br.containsHTML("(Sorry but this File is not avaible|Sorry, this Download doesnt exist anymore|This file does not exist)")) throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);

...
@HostPlugin(revision = "$Revision: 19422 $", interfaceVersion = 3, names = { "simply-debrid.com" }, urls = { "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32423" }, flags = { 2 })
public class SimplyDebridCom extends PluginForHost {

    private static HashMap<Account, HashMap<String, Long>> hostUnavailableMap = new HashMap<Account, HashMap<String, Long>>();

    public SimplyDebridCom() {
        super();
    ...
    public void handleMultiHost(DownloadLink link, Account account) throws Exception {
        ...
        if (!this.dl.startDownload()) {
            ...
            if (errormessage != null && (errormessage.startsWith("Server does not support chunkload") || errormessage.equals("Unerwarteter Mehrfachverbindungsfehlernull"))) {
                {

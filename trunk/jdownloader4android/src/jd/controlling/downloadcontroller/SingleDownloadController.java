...
public class SingleDownloadController extends BrowserSettingsThread implements StateMachineInterface, IOPermission {
    ...
    public SingleDownloadController(DownloadLink dlink, Account account, DownloadSpeedManager manager) {
        ...
        downloadLogger = LogController.TRASH;
    ...
    public void run() {
        try {
            ...
            //we are going to download this link, create new liveplugin instance here we want a fresh ClassLoader for this download!
            ...
            //TODO: revisar eleccion plugin
            downloadLink.setLivePlugin(downloadLink.getDefaultPlugin());
            originalPlugin=downloadLink.getDefaultPlugin();

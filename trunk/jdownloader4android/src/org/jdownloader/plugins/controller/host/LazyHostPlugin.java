...
public class LazyHostPlugin extends LazyPlugin<PluginForHost> {
    ...
    public LazyHostPlugin(AbstractHostPlugin ap, Class<PluginForHost> class1, ClassLoader classLoaderChild) {
    ...
    @Override
    public PluginForHost newInstance(ClassLoader classLoader) throws UpdateRequiredClassNotFoundException {
    ...
    @Override
    public PluginForHost getPrototype(ClassLoader classLoader) throws UpdateRequiredClassNotFoundException {
        PluginForHost ret = null;
        try {

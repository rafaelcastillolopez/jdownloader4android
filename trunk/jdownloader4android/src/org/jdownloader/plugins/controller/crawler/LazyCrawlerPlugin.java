...
public class LazyCrawlerPlugin extends LazyPlugin<PluginForDecrypt> {
    ...
    public LazyCrawlerPlugin(AbstractCrawlerPlugin ap, Class<PluginForDecrypt> class1, ClassLoader classLoader) {
    ...
    @Override
    public PluginForDecrypt newInstance(ClassLoader classLoader) throws UpdateRequiredClassNotFoundException {
    ...
    @Override
    public PluginForDecrypt getPrototype(ClassLoader classLoader) throws UpdateRequiredClassNotFoundException {
        PluginForDecrypt ret = null;
        try {

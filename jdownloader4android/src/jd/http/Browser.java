            ...
            if (form.getEncoding() == null || !form.getEncoding().toLowerCase().endsWith("form-data")) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (entry.getValue() == null) {
                        ...
                        request.addFormData(new FormData(entry.getKey() + ".x", (String)entry.getProperty("x", (int) (Math.random() * 100) + "")));
                        request.addFormData(new FormData(entry.getKey() + ".y", (String)entry.getProperty("y", (int) (Math.random() * 100) + "")));

...
import org.apache.harmony.luni.lang.reflect.ImplForArray;
import org.apache.harmony.luni.lang.reflect.ImplForType;
...
public class JSonStorage {
    ...
    private static void canStoreIntern(final Type gType, final String path) throws InvalidTypeException {
        ...
        } else if (gType instanceof ImplForType) {
            final ImplForType ptype = (ImplForType) gType;

            final Class<?> raw = ((ImplForType) gType).getRawType();
        ...
        } else if (gType instanceof ImplForArray) {
            final ImplForArray atype = (ImplForArray) gType;

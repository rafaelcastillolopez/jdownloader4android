    ...
    public Object jsonToObject(final JSonNode json, final Type type) throws MapperException {
        ...
        try {
            ...
            if (type instanceof ImplForType) {
                clazz = ((ImplForType) type).getRawType();
            ...
            if (type instanceof Class) {
                ...
                if (Collection.class.isAssignableFrom(clazz)) {
                    ...
                    final Type gType;
                    if (gs instanceof ImplForType) {
                        gType = ((ImplForType) gs).getActualTypeArguments()[0];
                    } else {
                        gType = void.class;
                    }
                    ...
                    final Type gType;
                    if (gs instanceof ImplForType) {
                        gType = ((ImplForType) gs).getActualTypeArguments()[1];
                    } else {
                        gType = void.class;
                    }
            ...
            } else if (type instanceof ImplForType) {
                final ImplForType pType = (ImplForType) type;
